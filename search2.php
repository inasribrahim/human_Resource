...
require "../session/session.php"; 
 ...
 if ($fname == null )
 {
 	 header('location:search.php?Empty= User Not Found  :)');
...
<article>
		<section>
			<div class="sec2">
	<label> Code  </label>
	<input type="text" placeholder="201620xx" name="" value="<?php echo  $code ?>" disabled >
		<br>
		<label> Name  </label>
		<br>
				<div id="ctextf">
		<input type="text" placeholder="Frist-Name" name="" value="<?php echo $fname ?>" disabled >
	</div>
	<div id="ctextl">
		<input type="text" placeholder="Last-Name" name="" value="<?php echo  $lname ?>"  disabled>
	</div>
	<br>
	<label> Phone </label>
	<br>
